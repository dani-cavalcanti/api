...
class MedicoRepositoryTest {
    ...
    void escolherMedicoAleatorioLivreNaDataCenario1() {
        ...
        var proximaSegundaAs10 = LocalDate.now()
                ...
                .atTime(10, 0);
        var medico = cadastrarMedico("Eloá Alice Lara", "eloara@voll.med", "521179", Especialidade.CARDIOLOGIA);
        var paciente = cadastrarPaciente("Nathan Leandro Benício das Neves", "nlbneves@ceviu.com.br", "75916483732");
